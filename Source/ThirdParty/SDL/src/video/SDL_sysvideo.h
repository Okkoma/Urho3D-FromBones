...
struct SDL_VideoDevice
{
	...
	void (*OnWindowLeave) (_THIS, SDL_Window * window);
	void (*OnWindowBeginConfigure) (_THIS, SDL_Window * window);
...
extern void SDL_OnWindowPositionChanged(SDL_Window * window);
...
extern void SDL_OnWindowBeginConfigure(SDL_Window * window);
