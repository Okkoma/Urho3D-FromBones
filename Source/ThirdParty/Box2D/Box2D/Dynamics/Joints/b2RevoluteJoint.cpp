...
void b2RevoluteJoint::Dump()
{
	...
	b2Log("  b2RevoluteJoint j;\n");
	b2Log("  j.localCenterA.Set(%.15lef, %.15lef);\n", m_bodyA->m_sweep.localCenter.x, m_bodyA->m_sweep.localCenter.y);
	b2Log("  j.localCenterB.Set(%.15lef, %.15lef);\n", m_bodyB->m_sweep.localCenter.x, m_bodyB->m_sweep.localCenter.y);
    b2Log("  j.invMassA = %.15lef;\n", m_bodyA->m_invMass);
    b2Log("  j.invMassB = %.15lef;\n", m_bodyB->m_invMass);
    b2Log("  j.invIA = %.15lef;\n", m_bodyA->m_invI);
    b2Log("  j.invIB = %.15lef;\n", m_bodyB->m_invI);
}
